...
public class PostsApiControllerTest {
    ...
    public void Posts_등록() throws Exception {
        ...
        PostsSaveReqDto dto = PostsSaveReqDto.builder().title(title).content(content).author("author").build();
    ...
    public void Posts_수정() throws Exception {
        ...
        PostsUpdateReqDto dto = PostsUpdateReqDto.builder().title(expectedTitle).content(expectedContent).build();

        String url = "http://localhost:" + port + "/api/v1/posts/" + updateId;

        HttpEntity<PostsUpdateReqDto> requestEntity = new HttpEntity<>(dto);
